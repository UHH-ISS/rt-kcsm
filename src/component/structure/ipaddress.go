...
const IP_ADDRESS_LENGTH = 17

type IPAddress [IP_ADDRESS_LENGTH]byte
...
func (ipAddress IPAddress) IsInternal() bool {
...
func (ipAddress IPAddress) Bytes() [IP_ADDRESS_LENGTH]byte {
	return ipAddress
}
